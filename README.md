...
This package is HONIORA_site_v303, updated 2026-09-10. Bug fix: the HONIORA hero wordmark now shrinks to fit its column instead of overflowing and breaking the hero's centered alignment on real-world laptop-width windows (reported on an actual MacBook Air Chrome window, not a simulated breakpoint).
